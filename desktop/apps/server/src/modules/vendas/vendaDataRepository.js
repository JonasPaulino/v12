  ...
  const venda = db
    .prepare(
      `SELECT
         ...
         n.cancelamento_protocolo AS nfce_cancelamento_protocolo,
         n.cancelamento_cstat AS nfce_cancelamento_cstat,
         n.cancelamento_motivo AS nfce_cancelamento_motivo,
         n.cancelamento_xml AS nfce_cancelamento_xml,
         n.cancelamento_raw_retorno AS nfce_cancelamento_raw_retorno,
         n.cancelada_em AS nfce_cancelada_em,
