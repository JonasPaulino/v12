...
export const useConfiguracaoFiscalPage = () => {
  ...
  const applyData = useCallback((payload) => {
    ...
    setForm({
      ...
      serie_nfce_padrao: String(fiscal.serie_nfce_padrao ?? 1),
      proximo_numero_nfce: String(fiscal.proximo_numero_nfce ?? 1),
      nfce_id_token_csc: fiscal.nfce_id_token_csc || "",
      nfce_csc: "",
      nfce_csc_masked: fiscal.nfce_csc_masked || "",
      nfce_ind_pres_padrao: fiscal.nfce_ind_pres_padrao || "1",
      ambiente_mdfe: fiscal.ambiente_mdfe || "2",
      serie_mdfe_padrao: String(fiscal.serie_mdfe_padrao ?? 1),
      proximo_numero_mdfe: String(fiscal.proximo_numero_mdfe ?? 1),
      crt: fiscal.crt || "3",
      cnae: fiscal.cnae || "",
      natureza_operacao_padrao: fiscal.natureza_operacao_padrao || "",
      nfe_habilitada: !!fiscal.nfe_habilitada,
      mdfe_habilitado: fiscal.mdfe_habilitado !== false,
    ...
    async (event) => {
      ...
      try {
        ...
        const payload = {
          ...
          ambiente_nfce: form.ambiente_nfce,
          nfce_habilitada: form.nfce_habilitada,
          serie_nfce_padrao: form.serie_nfce_padrao,
          proximo_numero_nfce: form.proximo_numero_nfce,
          nfce_id_token_csc: form.nfce_id_token_csc,
          nfce_csc: form.nfce_csc,
          nfce_ind_pres_padrao: form.nfce_ind_pres_padrao,
          ambiente_mdfe: form.ambiente_mdfe,
          serie_mdfe_padrao: form.serie_mdfe_padrao,
          proximo_numero_mdfe: form.proximo_numero_mdfe,
          crt: form.crt,
          cnae: form.cnae,
          natureza_operacao_padrao: form.natureza_operacao_padrao,
          nfe_habilitada: form.nfe_habilitada,
          mdfe_habilitado: form.mdfe_habilitado,
