...
import devolucaoMercadoriaRoutes from "./routes/devolucaoMercadoriaRoutes.js";
import nfeManifestacaoRoutes from "./routes/nfeManifestacaoRoutes.js";
...
app.use("/gestao", verificarToken, requireMaster, gestaoPessoaRoutes);
...
privateRouter.use("/devolucao-mercadoria", devolucaoMercadoriaRoutes);
privateRouter.use("/nfe-manifestacao", nfeManifestacaoRoutes);
privateRouter.use("/notificacoes", notificacaoRoutes);
